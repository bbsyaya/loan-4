 ...
 * 
 * @author XLY
 * @version $Id: CustomerInfoBaseInsertReq.java, v 0.1 2015-2-16 下午4:55:36 XLY Exp $
 */
public class CustomerInfoBaseReq extends AbstractRequest implements Serializable{

    /**  */
    private static final long serialVersionUID = 5471460406708447395L;
    ...
    public String toString() {
        return "CustomerInfoBaseInsertReq [custId=" + custId + ", acustId=" + acustId
