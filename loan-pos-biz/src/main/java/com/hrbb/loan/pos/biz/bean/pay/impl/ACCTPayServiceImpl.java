...
public class ACCTPayServiceImpl implements IPayService {
    ...
    private static final Logger          logger = LoggerFactory.getLogger(ACCTPayServiceImpl.class);
    ...
    public boolean pay() throws Exception {
        ...
        loanPosBusinessCodeService = (LoanPosBusinessCodeService) SpringBeans
            .getBean("loanPosBusinessCodeService");
        loanPosContractManagementBiz = (LoanPosContractManagementBiz) SpringBeans
            .getBean("loanPosContractManagementBiz");
        madeLoanProcessBizHession = (MadeLoanProcessBizHession) SpringBeans
