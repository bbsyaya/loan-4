...
@Service("wxPaybackTryCalculate")
public class WXPaybackTryCalculateImpl extends WXHService {
    
	private static final Logger LOGGER = LoggerFactory.getLogger(WXPaybackTryCalculateImpl.class);
	...
	public HResponse serve(HRequest request) throws HServiceException {
		...
		if (!StringUtils.isEmpty(paymentApplyNo)) {
			...
			/*判断该笔用款的状态*/
			if(receipt==null){
			    LOGGER.info("["+paymentApplyNo+"]不存在对应的有效用款");
