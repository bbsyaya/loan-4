...
<html>
  <head>
    <title>notMatchedPaybackImport</title>
	...
	<script type="text/javascript">
       ...
       function openRelateReceipt(){
		...
		$(function() {
		<%com.hrbb.loan.web.security.entity.AccessPrivilege access = (com.hrbb.loan.web.security.entity.AccessPrivilege) session
			...
			if (!access.hasAnyPrivilege("ROLE_REPAY_QUERY")
					|| (viewStatus != null && !viewStatus.equals("99"))) { //具有全量查询权限时,初始化不进行查询
					%>
			queryPaybackImport();
		<%}%>
