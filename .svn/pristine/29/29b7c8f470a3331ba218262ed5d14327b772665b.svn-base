...
public class TCreditApplyAprvInfoDaoImpl extends SqlSessionDaoSupport implements
    ...
    public List<String> selectByApprvBeginTime(String timeout) {
        return getSqlSession().selectList("TCreditApplyAprvInfoMapper.selectLoanIdByApprvBeginTime",timeout);
    }

    @Override
    public String getApprIdByRuleAndLessWork(List<String> apprIdList) {
        return getSqlSession().selectOne("TCreditApplyAprvInfoMapper.getApprIdByRuleAndLessWork", apprIdList);
    }

    @Override
    public List<String> getReviewPersons(String roleid) {
        return getSqlSession().selectList("TCreditApplyAprvInfoMapper.getReviewPersons", roleid);
    }

    @Override
    public List<String> getReviewPersons2(Map<String, Object> reqMap) {
        return getSqlSession().selectList("TCreditApplyAprvInfoMapper.getReviewPersons2",reqMap);
    }

    @Override
    public String getApprIdFromList(List<String> ls) {
        return getSqlSession().selectOne("TCreditApplyAprvInfoMapper.getApprIdFromList", ls);
    }
}
