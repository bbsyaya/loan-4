...
<div id="tb" style="padding:5px;height:auto">
	...
	<table width="800" border="0" cellspacing="1" cellpadding="0">
	  <tr>
	    <td width="90">申请编号:</td>
	    <td width="180"><input id="searchBizLoanId" name="searchBizLoanId" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	    <td width="90">商户名称:</td>
	    <td width="180"><input id="searchPosCustName" name="searchPosCustName" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	    <td width="90">客户姓名:</td>
	    <td width="180"><input id="searchCustName" name="searchCustName" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	  </tr>
	  <tr>
	    <td width="90">客户证件号:</td>
	    <td width="180"><input id="searchPaperId" name="searchPaperId" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	   	<td width="90">推荐机构:</td>
	    <td width="180"><input id="searchRecOrg" name="searchRecOrg" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	    <td width="90">推荐人:</td>
	    <td width="180"><input id="searchRecPerson" name="searchRecPerson" style="line-height:20px;border:1px solid #ccc;width:90%"/></td>
	  </tr>
	  <tr>
	    <td width="90">业务渠道:</td>
	    <td width="180">
	    <select id="searchChannel" name="searchChannel" style="width:90%">
				<option value=""></option>
	    ...
	    <td width="90">省份:</td>
	    <td width="180">
	    <select id="searchRegion" name="searchRegion" style="width:90%">
	    	<option value=""></option>
    ...
    <%com.hrbb.loan.web.security.entity.AccessPrivilege access = (com.hrbb.loan.web.security.entity.AccessPrivilege) session.getAttribute("accessPrivilege"); %>
   	<% if(access.hasAnyPrivilege("ROLE_AUDIT_ADMIN")){ %>
   		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onClick="openAdjustApproval()">复审调件</a>&nbsp;&nbsp;
   	<%} %>
    </div>
</div> 