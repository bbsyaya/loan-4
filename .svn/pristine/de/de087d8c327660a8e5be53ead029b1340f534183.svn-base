...
<html>
	...
	"menus": [{
		...
		<%if (access.hasAnyPrivilege("ROLE_APPLY;ROLE_INFO;ROLE_APPLY_QUERY;ROLE_APPLY_VIEWALL")) {%>
		{
		"menuid": "1",
		"icon": "icon-tip",
		"menuname": "授信申请管理",
		"menus": [
			...
			<%} %>
			<%if(access.hasAnyPrivilege("ROLE_APPLY_QUERY;ROLE_APPLY_VIEWALL")){		//申请管理权限%>
				{
					"menuid": "19",
					"menuname": "所有申请",
					"icon": "icon-min-edit",
