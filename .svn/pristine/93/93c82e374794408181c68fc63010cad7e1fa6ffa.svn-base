...
public class TRepaymentPlanDaoImpl extends SqlSessionDaoSupport implements TRepaymentPlanDao {
    ...
    public Map<String, Object> getBatchRecentRepayPlan(String receiptId) {
        return getSqlSession().selectOne("TRepaymentPlanMapper.getBatchRecentRepayPlan", receiptId);
    }

	@Override
	public List<Map<String, Object>> getDueRepaymentSevenDaysLaterOther(
			Map<String, Object> reqMap) {
		return getSqlSession().selectList("TRepaymentPlanMapper.getDueRepaymentSevenDaysLaterOther", reqMap);
	}
