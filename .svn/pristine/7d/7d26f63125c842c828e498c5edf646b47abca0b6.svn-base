...
public class ReceiptInfoServiceImpl implements ReceiptInfoService {
    ...
    public List<TReceiptInfo> getUnFinishedReceipt() {
        return tReceiptInfoDao.selectUnFinishedReceipt();
    }

    public Map<String, Object> selectReceiptInfoByReceiptId(String receiptId) {
        return tReceiptInfoDao.selectByReceiptId(receiptId);
    }
}
