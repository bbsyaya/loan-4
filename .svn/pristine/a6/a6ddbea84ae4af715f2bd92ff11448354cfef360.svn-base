 ...
 * 
 * @author 
 * @version $Id: RNCreditApplyHServiceImpl.java, v 0.1 2015-8-21 上午11:42:43  Exp $
 */
@Service("rnCreditApply")
public class RNCreditApplyHServiceImpl extends RNService{
...
/*		if (!StringUtil.isEmpty(qqno)) {
		...
		if(!executeExtensionAction(creMap, custMap, null, bankMap, null)){
		...
		Map<String, Object> resMap = loanPosCreditApplyBackStageBiz
				.creditApplyReg(creMap, custMap, null, bankMap, null,
						null);
