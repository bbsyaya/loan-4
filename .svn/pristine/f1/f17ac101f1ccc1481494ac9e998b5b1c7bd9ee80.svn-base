...
public class SaleAppApplyHServiceConstants {
	...
	// 申请额度
	public static final String tcapi = "tcapi";

	// 申请期限
	public static final String tterm = "tterm";
	...
	// 银行账号/卡号
	public static final String bankaccno = "indesubsacno";
	...
	//用款日期
	public static final String desireddate = "desireddate";
    //资金用途
	public static final String applyMemo = "loanuse";
