<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div title="贷款申请信息" style="padding:20px;">
		<table id="editform" style="width:860px; "><tr><td><fieldset style="padding:5px; color:#333; border:#06c dashed 1px;">
			<legend class='dialog-label' style="color:#06c; font-weight:800; background:#fff;">业务申请</legend>
               	<table width="100%">
					...
					<tr>
						<td class="tdtitle">申请金额:</td><td><input id="editApplyAmt" name="editApplyAmt" class="easyui-numberbox" disabled value="${applyDetail[0].applyAmt}"/>（元）</td>
					...
					<tr>
						<td class="tdtitle">偿还方式:</td><td><select id="editRepayMethod" name="editRepayMethod" class="easyui-combobox" disabled>
					...
					<tr>
						...
						<td class="tdtitle">还款方式:</td><td><select id="editReturnKind" name="editReturnKind" disabled 
								data-options="width:150" class="easyui-combobox">
					...
					<tr>
						...
						<td colspan="3"><table><tr>
							<td>
							<select	id="editBankName" name="editBankName" class="easyui-combobox" >
