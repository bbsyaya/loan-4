 ...
 */
@Service("tcPosSerial")
public class TCPosSerialHServiceImpl extends TCService{
	
//	private Logger logger = LoggerFactory.getLogger(TCPosSerialHServiceImpl.class);
	...
	public HResponse serve(HRequest request) throws HServiceException {
		...
		boolean bol = loanPosCreditApplyBackStageBiz.updloadPosSerial(this.getChannel(),
