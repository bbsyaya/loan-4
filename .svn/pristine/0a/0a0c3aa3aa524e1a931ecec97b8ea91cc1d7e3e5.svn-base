...
@Service("umPaymentApply")
public class UmPaymentApplyServiceImpl implements HService{
	
	Logger logger = LoggerFactory.getLogger(UmPaymentApplyServiceImpl.class);
	...
	public HResponse serve(HRequest request) throws HServiceException{
		...
		if(respMap.isEmpty()){
			respMap.put(PaymentApplyConstants.LIST_ID, "");
