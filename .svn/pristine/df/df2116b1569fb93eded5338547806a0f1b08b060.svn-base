...
public class CreditSuggestionComputer {
	...
	public static RiskSuggestionBean getRiskSuggection(MultResultBean m,
			...
			String prodId, String riskCheckResult, String occurType) {
...
//		if (m.getRawModelScore().compareTo(m.getCutScore()) < 0) {
		...
		// 建议通过 (如果是续贷，则建议通过并提交到复审1)
		if (StringUtils.isEmpty(sb.toString())||BusinessDictionaryConstants.OCCURTYPE_02.equals(occurType)) {
