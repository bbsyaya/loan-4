	...
	public void execute() throws EventException {
		...
		switch(type){
			...
			case MessageCab.消息推送_影像文件缺失通知:
			    String contNo = (String) source.getAttribute("contNo");
			    TCreditApply tCreditApply = (TCreditApply) source.getAttribute("tCreditApply");
			    message = new ImageMissingEventAdapter(tCreditApply, contNo);
				break;
