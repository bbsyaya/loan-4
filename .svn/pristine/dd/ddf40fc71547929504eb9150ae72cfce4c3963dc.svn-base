 ...
 *          marco Exp $
 */
@Service("tcApprResultConfirm")
public class TCApprResultConfirmServiceImpl extends TCService {

	private final Logger logger = LoggerFactory
			.getLogger(TCApprResultConfirmServiceImpl.class);
	...
	public HResponse serve(HRequest request) throws HServiceException {
		...
		logger.debug("executing TCApprResultConfirmServiceImpl...");
