...
/**
* <p>Title: IStatisticsExecuteDao.java </p>
* <p>Description:  </p>
...
* logs: 1. 
*/
public interface IStatisticsExecuteDao {
	
	//public List<Map<String, Object>> selectSelective(String qryType, Map<String, Object> reqMap);
	...
	public List<Map<String, Object>> selectDailyEntries(Map<String, Object> reqMap);
	
	public List<Map<String, Object>> selectDailyExecutes(Map<String, Object> reqMap);
