...
@Service("tcQueryApplyInfo")
public class TCQueryApplyInfoHServiceImpl extends TCService{
...
*/		String stdshno = (String)props.get(CreditApplyHServiceConstants.stdshno);
		...
		Map<String, Object> resMap = loanPosCreditApplyBackStageBiz.getCreditApplyDetailByShmerno(stdshno, stdmerno, null, null, this.getChannel());
		resMap.remove("imagefilepackagename");
		resMap.remove("stdmerno");
		if(resMap.isEmpty()){
