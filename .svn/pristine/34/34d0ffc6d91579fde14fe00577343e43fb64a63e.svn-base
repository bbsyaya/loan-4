		...
		<tr><td><fieldset style="padding:5px; color:#333; border:#06c dashed 1px;">
			<legend class='dialog-label' style="color:#06c; font-weight:800; background:#fff;">用款申请信息</legend>
                	<table style="width:100%;">
                		<tr>
                			<td class="tdtitle">业务渠道:</td><td><input type="text" id="channel" readonly="readonly" class="channel" value="${channelName}" size="30"/></td>
                			<td class="tdtitle">用款申请编号:</td><td><input type="text" id="payApplyId" readonly="readonly" class="payApplyId" value="${paymentApply.payApplyId}" size="30"/></td>
                		</tr>
                		<tr>
                		...
                		<tr>
	                		<td class="tdtitle">用款金额</td><td><input type="text" id="payApplyAmt" name="payApplyAmt" readonly="readonly" value="${paymentApply.payApplyAmt}" size="30"/></td> 
