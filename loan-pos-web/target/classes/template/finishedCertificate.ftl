...
<table>
	<tr><td width="500"></td><td align="left">银行盖章：</td></tr>
	<tr><td width="500"></td><td align="left"><span class="underLine">${endYear}</span>年<span class="underLine">${endMonth}</span>月<span class="underLine">${endDay}</span>日</td></tr>
</table>
</div>
