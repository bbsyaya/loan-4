...
<%if(access.hasAnyPrivilege("ROLE_INFO_APPR;ROLE_APPR_LV1;ROLE_APPR_LV2;ROLE_APPR_LV3;ROLE_APPR_LV4")){%>
  <tr>
...
<script type="text/javascript">
	...
	function redir2TaskTips4(){
		window.parent.addTab("未结清业务","<%=request.getContextPath()%>/navigation/queryFacilityNav.do?bizStatus=02","icon-min-edit");
	}
</script>
<%} %>
