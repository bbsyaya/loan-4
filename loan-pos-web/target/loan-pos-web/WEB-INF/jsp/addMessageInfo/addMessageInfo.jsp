...
<title>业务申请</title>
	...
	function addInfoMessage(){
		...
		var reqUrl = "<%=request.getContextPath()%>/backStageAddMessage/addInfoMessage.do";
		$.post(
			reqUrl, {fileName: fileName}, function(obj){
			alert(obj);
		});
	}
...
<body>
	...
	<table border="1">
		<tr>
			<td>文件名:</td>
			<td><input name="fileName" id="fileName"/></td>
			<td><input type="button" onclick="addInfoMessage()"/></td>
		</tr>
	</table>
