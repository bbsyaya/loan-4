		...
		<fieldset style="padding:5px; color:#333; border:#06c dashed 1px;width:860px">
      	...
      	<table width="860px">
      		...
      		<tr>
      			...
      			<td class="tdtitle">证件号码:</td><td><input type="text" id="detailPaperId1" readonly="readonly" value="${applyDetail[1].paperId}" size="30"/></td> 
      		</tr>
      		<tr>
      		...
      		<td class="tdtitle">授信利率:</td><td><input type="text" id="detailCreditInterest" readonly="readonly" value="${contract.creditInterest}" size="30"/></td> 
      		</tr>
      		<tr>
              <td class="tdtitle">授信期限:</td><td><input type="text" id="detailContTerm" readonly="readonly" value="${contract.contTerm}" size="30"/></td> 
      		<td class="tdtitle">还款方式:</td><td>
      		...
      		<tr>
      		<td class="tdtitle">协议生效日期:</td><td><input type="text"  id="detailAgreementBiginDate" readonly="readonly" value="${contract.beginDateStr}" size="30"/></td> 
      		<td class="tdtitle">协议到期日期:</td><td><input type="text"  id="detailAgreementEndDate" readonly="readonly" value="${contract.endDateStr}" size="30"/></td>
      		</tr>
      		<tr>
      			<td class="tdtitle">收款账号:</td><td><input type="text" id="detailAccountNo" readonly="readonly" value="${contract.acceptAccount}" size="30"/></td>
      			<td class="tdtitle">账户开户行:</td><td><input type="text" id="detailBankName1" readonly="readonly" value="${contract.accountOpenBank}" size="30"/></td>
      		</tr>
      	</table>
      	</fieldset>
      	<br/>
		<c:if test="${applyDetail[0].repayMethod eq '01'}">
		<fieldset style="padding:5px; color:#333; border:#06c dashed 1px;width:860px">
