...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
			...
			<table id="applyform" style="width:860px; ">
			<tr><td><fieldset style="padding:5px; color:#333; border:#06c dashed 1px;"><legend class='dialog-label' style="color:#06c; font-weight:800; background:#fff;">发生方式</legend>
				<table style="width:100%;"><jsp:include page="insertCreditOccurTypeInfo.jsp"></jsp:include></table>
				</fieldset></td></tr>
			<tr><td><fieldset style="padding:5px; color:#333; border:#06c dashed 1px;">
				...
				<table width="100%">
					...
					<tr>
						<td class="tdtitle">
							<input type="hidden" id="insertApplyTerm"	name="insertApplyTerm" value="36"/>申请金额:</td>
					...
					<tr>
						...
						<td><select id="insertReturnKind" name="insertReturnKind" 
								data-options="width:150,panelHeight:80" class="easyui-combobox">
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td><input type="hidden" id="insertRecManager"	name="insertRecManager"/></td>
					</tr>
					<tr>
						<td class="tdtitle">备注:</td>
						<td colspan="3"><textarea id="insertRemark" name="insertRemark" cols="80" rows="2" ></textarea></td>
					</tr>
