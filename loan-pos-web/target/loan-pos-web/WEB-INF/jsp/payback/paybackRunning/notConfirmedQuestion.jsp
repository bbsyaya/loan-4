...
<html>
  <head>
    <title>notConfirmedQuestion</title>
    ...
    <script type="text/javascript">
    	function queryPaybackRunningInfo(){
			$('#tt').datagrid('load',{	
  ...
  <body>
	...
	<div id="tb">   
    <a href="javascript:void(0)" id="01" class="easyui-linkbutton" iconCls="icon-cut" plain="true" onclick="relateAccountImport()">关联账户进项</a> 
    <a href="javascript:void(0)" id="01" class="easyui-linkbutton" iconCls="icon-cut" plain="true" onclick="confirmOffset()">确认冲销</a> 
    </div>  
	...
	<div id="tb" style="padding:3px">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="queryPaybackRunningInfo()">查询</a>
	</div>
	</div>  
