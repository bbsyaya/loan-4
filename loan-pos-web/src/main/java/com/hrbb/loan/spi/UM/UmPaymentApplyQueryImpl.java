...
@Service("umPaymentApplyQuery")
public class UmPaymentApplyQueryImpl implements HService {
	
	@Autowired
	private IPaymentApplyBiz paymentApplyBiz;
	
	private Logger logger = LoggerFactory.getLogger(UmPaymentApplyQueryImpl.class); 
	...
	public HResponse serve(HRequest request) throws HServiceException {
		...
		Map<String, Object> resMap = paymentApplyBiz.queryPaymentByStdmerno(null, null, null, stdshno, stdmerno, BusinessDictionaryConstants.BIZ_CHANNEL_UM, startnum, recnum);
		if(reqMap.isEmpty()){
