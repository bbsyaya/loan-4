...
@Service("smCreditApplyHService")
public class SMCreditApplyHServiceImpl extends SMHService{
...
/*		if (!StringUtil.isEmpty(qqno)) {
		...
		//起线程下载影像资料
		creMap.put("custid", resMap.get("custid"));
		creMap.put("loanid", resMap.get("loanid"));
