 ...
 * 基础控制器接口
 */
public interface BaseController<T extends Identifiable<K>, Q extends T, K> {
	/**
	...
	/**
	 * 跳转到添加页面为insertXXX页面<br>示例Bean对象:SysDictionay->生成路径：/admin/user
	 * <blockquote>
	 * 	<table cellpadding=1 border=1  cellspacing=0 summary="Capturing group numberings">
	 * 		<tr>
	 *     		<th><tt>路径&nbsp;&nbsp;&nbsp;&nbsp;</tt></th>
	 ...
	 *      </tr>
	 *      <tr>
	 *     		<th><tt>/admin/user/add</tt></th>
	 * 			<th>get</th>
	 *     		<th><tt>/user/addUser.ftl</tt></th>
	 *      </tr>
	 * </table>
	 * </blockquote>
	 * @return ModelAndView
	 ...
	 * @return ModelAndView
	 */
	public ModelAndView viewOne(K id);
	 ...
	 * @return ModelAndView
	 */
	public ModelAndView editView(K id);
}
