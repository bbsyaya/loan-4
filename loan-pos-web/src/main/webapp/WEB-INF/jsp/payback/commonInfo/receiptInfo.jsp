...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
		...
		<tr>
			...
			<td><input type="text" id="PaybackAccount" readonly="readonly"
				name="PaybackAccount" value="${receipt.payAccount}" size="30" /></td>
			<td class="tdtitle">账户开户行:</td>
			<td><input type="text" id="AccountOpenBank" readonly="readonly" name="AccountOpenBank"
				value="${receipt.accountOpenBank} / ${receipt.accountBranchBank} / ${receipt.accountSubBranchBank}"
				size="30" /></td>
		</tr>
		<tr>
