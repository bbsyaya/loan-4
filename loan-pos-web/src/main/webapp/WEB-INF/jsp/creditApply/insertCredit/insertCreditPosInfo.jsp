...
<!--新增窗口-->
	<div title="pos流水信息" style="padding:20px">
		<div>	
				<iframe id="insertIframe" name="insertIframe" frameborder="0"
					height="50px" width="100%" scrolling="no"></iframe>
		</div>
		<table id="posSerialInsertTable" width="width:100%"
			style="height:400px;"
			...
			<thead>
				<tr>
					...
					<th field="tradeType">交易类型</th>
					<th field="tradeAmt">交易金额</th>
					<th field="tradeNum">交易笔数</th>
