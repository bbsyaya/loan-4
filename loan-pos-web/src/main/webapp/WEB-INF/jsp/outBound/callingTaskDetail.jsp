...
<div title="任务详情">
	<table >
		<thead>
			...
			<tr>
				<td>外呼任务类型</td>
				<td><input id="callingTypeName" name="callingTypeName" value="${taskObj.callingTypeName}" style="line-height:20px;border:1px solid #ccc" disabled="disabled"/></td>
			</tr>
			<c:if test="${'11' == taskObj.callingType}">
				<tr>
					<td>拒绝原因：</td>
					<td colspan="3"><textarea id="info" name="info" cols="50" rows="3" readonly="readonly">${taskObj.info}</textarea></td>
				</tr>
			</c:if>
			<tr>
				<td>任务生成时间</td>
