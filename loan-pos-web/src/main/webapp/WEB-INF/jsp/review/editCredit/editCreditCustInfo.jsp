    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
					...
					<tr>
						...
						<td class="tdtitle">办公电话:</td><td><input class="easyui-validatebox" validType="tel" invalidMessage="电话号码填写错误,格式xxx-xxx" size="30"
							type="text" id="editTel" name="editTel" data-options="required:true" value="${applyDetail[1].tel}"/></td>
					</tr>
					<tr>
						<td class="tdtitle">居住地址:</td>
						<td colspan="3"><table><tr>
							<td>
							<select  id="editResidentProv" name="editResidentProv" class="easyui-combobox" disabled>
							...
							&nbsp;
							<select id="editResidentCity"	name="editResidentCity" class="easyui-combobox" disabled>
								<option value="${applyDetail[1].residentCity}">${applyDetail[1].residentCityName}</option>
							</select>
							&nbsp;
							<select id="editResidentDivision" name="editResidentDivision" class="easyui-combobox" disabled>
							...
							<input type="text" id="editResidentDetail"
								name="editResidentDetail" class="easyui-validatebox" data-options="required:true" style="width:280px" value="${applyDetail[1].residentDetail}"/>
							</td>
							</tr></table>
						</td>
					</tr>
