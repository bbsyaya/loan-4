			...
			<fieldset style="padding:5px; color:#333; border:#06c dashed 1px;" >
				...
				<table width="100%">
					<tr>
						...
						<td width="35%"><input id="payApplyTerm" name="payApplyTerm" size="30" maxlength="1" value="12" class="easyui-numberbox"/></td>
					</tr>
					<tr>
						<td class="tdtitle">期望用款日期</td>
						<td><input id="expectedDate" name="expectedDate" class="easyui-datebox" value="<fmt:formatDate value='${beginDate}' pattern='yyyy-MM-dd'/>" size="30"
							data-options="onSelect:function(date){varifyStartDate(date);calculateExpectedEndDate();}"/></td>
						<td class="tdtitle">用款到期日</td>
						<td><input id="expectedEndDate" name="expectedEndDate" disabled="disabled" size="30" value="<fmt:formatDate value='${endDate}' pattern='yyyy-MM-dd'/>"/></td>
					</tr>
					<tr>
