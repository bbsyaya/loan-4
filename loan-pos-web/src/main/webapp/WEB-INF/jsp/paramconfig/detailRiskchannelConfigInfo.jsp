...
<div id="riskChannelDiv" title="机构信息"
  ...
  <table style="width: 100%">
    <tr>
      ...
      <td style="width: 35%;"><select id="riskChannel" class="easyui-combobox"
      ...
      <td><select id="risk_type_select" name="risk_type" class="easyui-combobox"
        style="width: 243px;" validType="selectedRequired"
    ...
    <tr>
      ...
      <td><input type="text" class="easyui-datebox valid_date" data-options="required:true"
        <c:if test="${oprFlag=='3'}">readonly="readonly"</c:if>
        name="valid_date"
        value='<fmt:formatDate value="${tRiskChannelConfig.valid_date}" pattern="yyyy-MM-dd"/>'
        size="30"></td>
      <td class="tdtitle">失效时间:</td>
      <td><input type="text" class="easyui-datebox invalid_date" data-options="required:true"
        <c:if test="${oprFlag=='3'}">readonly="readonly"</c:if>
        name="invalid_date"
