 ...
 * 
 * @author XLY
 * @version $Id: LoanPosBlacklistServiceImpl.java, v 0.1 2015-2-28 下午2:37:45 XLY
 *          Exp $
 */
@Service("loanPosBlacklistService")
public class LoanPosBlacklistServiceImpl implements LoanPosBlacklistService {
	@Autowired
