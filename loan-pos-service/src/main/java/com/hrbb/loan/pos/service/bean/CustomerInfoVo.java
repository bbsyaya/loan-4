 ...
 * 
 * @author XLY
 * @version $Id: CustomerInfoVo.java, v 0.1 2015-3-5 上午9:11:26 XLY Exp $
 */
public class CustomerInfoVo implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5717739993712450711L;
	/**客户ID*/
    ...
    private String operAddrProv;

    private String operAddrCity;
    ...
    public String getOperAddrProv() {
        return operAddrProv;
    }

    public void setOperAddrProv(String operAddrProv) {
        this.operAddrProv = operAddrProv;
    }

    public String getOperAddrCity() {
        return operAddrCity;
    }

    public void setOperAddrCity(String operAddrCity) {
        this.operAddrCity = operAddrCity;
    }
    ...
    public String toString() {
        return "CustomerInfoInsertReq [custId=" + custId + ", custName=" + custName
               ...
               + regiCode + ", dealScope=" + dealScope + ", operAddrProv=" + operAddrProv
               + ", operAddrCity=" + operAddrCity + ", operAddrDetail=" + operAddrDetail
