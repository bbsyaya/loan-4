...
import com.hrbb.loan.pos.dao.TCreditReportCardGuaranteeDao;
...
public class CreditInvestigateServiceImpl implements CreditInvestigateService {
	...
	@Autowired
	private TCreditReportCardGuaranteeDao tCreditReportCardGuaranteeDao;
	...
	@Override
	public int insertCreditReportCardGuarantee(Map<String, Object> reqMap) {
		return tCreditReportCardGuaranteeDao.insertSelectiveMap(reqMap);
	}
