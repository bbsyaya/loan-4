...
.preview{width:600px; height:665px; margin:20px 0px 0px 30px;}
/* smallImg */
...
/* bigImg */
.bigImg{position:relative; float:left; width:600px; height:600px; overflow:hidden;padding:6px 5px;}
.bigImg #midimg{width:600px; height:600px;}
.bigImg #winSelector{width:435px; height:410px;}
...
<div class="preview">
	<div id="vertical" class="bigImg">
		<img src="" width="600" height="600" alt="" id="midimg" />
	...
	<div class="smallImg">
		...
		<div id="imageMenu">
			...
			<c:forEach items="${loanPosImageData}" var="objImage">
		       <li id="onlickImg"> <img src="${imageUrl}imagedatawork/${loanId}/${objImage.fileName}"  width="100" height="68"></li>
			</c:forEach>
			</ul>
		</div>
