	 ...
	 <table id="agreementTT"  class="easyui-datagrid" 
		...
		<thead>
			<tr>
			    ...
			    <th field="contNo" width="230px">合同编号</th>
				<th field="custName" width="100px">客户名称</th>
				<th field="paperId" width="140px">证件号码</th>
				<th field="posCustName" width="200px">商户名称</th>
				<th field="creditLine" width="100px" align="right" formatter="formatMoney">授信金额（元）</th>
				<th field="creditInterest" width="100px" align="right" >授信利率（%）</th>
