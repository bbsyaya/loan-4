...
<title>search</title>
    ...
    function insertPaymentApply(){
		...
		$('#insert').openWin({
			...
			maximized:false,
			//width:800,
			href:'openInsertPaymentApply.do?contNo='+contNo+'&direct2Path=paymentApply/createPaymentApply/insertPaymentApply',
		});
	}	
	...
	function savePaymentApply(){
		...
		//var expectedEndDate = $("#expectedEndDate").datebox('getValue');
