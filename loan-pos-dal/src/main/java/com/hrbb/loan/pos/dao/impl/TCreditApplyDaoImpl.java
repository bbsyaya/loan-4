...
public class TCreditApplyDaoImpl extends SqlSessionDaoSupport implements TCreditApplyDao {
    ...
    /** 
     * @see com.hrbb.loan.pos.dao.TCreditApplyDao#selectChannelByLoanId(java.lang.String)
     */
    @Override
    public String selectChannelByLoanId(String loanId) {
        return getSqlSession().selectOne("TCreditApplyMapper.selectChannelByLoanId", loanId);
    }
    
    /** 
     * @see com.hrbb.loan.pos.dao.TCreditApplyDao#countDailyApply(java.util.Map)
     */
    @Override
    public Long countDailyApply(Map<String,Object> reqMap){
        return getSqlSession().selectOne("TCreditApplyMapper.countDailyApply",reqMap);
    }
