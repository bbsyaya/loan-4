...
public class TReceiptInfo implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8935956425581719297L;
    ...
    //渠道用款申请流水号
    private String stdisno;
    
	/**
	 * Getter method for property <tt>stdisno</tt>.
	 * 
	 * @return property value of stdisno
	 */
	public String getStdisno() {
		return stdisno;
	}

	/**
	 * Setter method for property <tt>stdisno</tt>.
	 * 
	 * @param stdisno value to be assigned to property stdisno
	 */
	public void setStdisno(String stdisno) {
		this.stdisno = stdisno;
	}
