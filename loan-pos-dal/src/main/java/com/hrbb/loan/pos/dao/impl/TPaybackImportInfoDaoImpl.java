...
public class TPaybackImportInfoDaoImpl extends SqlSessionDaoSupport implements TPaybackImportInfoDao {
	...
	public long countImportNumber(Map<String, Object> reqMap) {
		return getSqlSession().selectOne("TPaybackImportInfoMapper.countImportNumber", reqMap);
	}

	@Override
	public Map<String, Object> getImportInfobyId(String importRunningId) {
		return getSqlSession().selectOne("TPaybackImportInfoMapper.getImportInfobyId", importRunningId);
	}
