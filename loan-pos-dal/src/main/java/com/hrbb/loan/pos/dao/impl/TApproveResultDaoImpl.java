...
public class TApproveResultDaoImpl extends SqlSessionDaoSupport  implements TApproveResultDao{
	...
	public int deleteByPrimaryKey(String approveId) {
		return getSqlSession().insert("TApproveResultMapper.deleteByPrimaryKey", approveId);
	}
	...
	public int updateByPrimaryKeySelective(TApproveResult record) {
		return getSqlSession().update("TApproveResultMapper.updateByPrimaryKeySelective", record);
	}
	 ...
	 */
	@Override
	public int updateByApproveId(TApproveResult record) {
		  return getSqlSession().update("TApproveResultMapper.updateByApproveId", record);
	}
	...
	public int insertSelectiveToHist(TApproveResult record) {
		return getSqlSession().insert("TApproveResultMapper.insertSelectiveToHist", record);
	}
	...
	public int updateApproveResultInfo(Map<String, Object> approveBankMap) {
		 return getSqlSession().update("TApproveResultMapper.updateApproveResultInfo", approveBankMap);
	}
